import numpy as np
from ImagesClasses.ImageFunction2 import ImageFunction2
from ImagesClasses.PaperImage import PaperImage
import cv2
import os
...
class Paper:
    ...
    def set_position(self, top_image, bottom_image):
        ...
        self.composed_image = ImageFunction2(self.camera, top_image, bottom_image, self.image_config)
