...
class Camera:
    ...
    def get_fov_corners(self, camera_box):
        top_left = (camera_box.x - self.fov_h_mm / 2, camera_box .y - self.fov_v_mm / 2)
        top_right = (camera_box.x  + self.fov_h_mm / 2, camera_box .y - self.fov_v_mm / 2)
        bottom_left = (camera_box.x  - self.fov_h_mm / 2, camera_box .y + self.fov_v_mm / 2)
        bottom_right = (camera_box .x + self.fov_h_mm / 2, camera_box .y + self.fov_v_mm / 2)
        return {
            'top_left': top_left,
            'top_right': top_right,
